...
var CD_KO=[
 ...
 [{r:'user',t:'역할 좀 나눠줘'},
  ...
  {r:'ai',t:'선호·회피·난이도 균형으로 배정했어요.<br>박세원 <b>기획·PM</b> · 함봉구 <b>백엔드</b><br>이민지 <b>디자인·UX</b> · 김주호 <b>프론트엔드</b><br>확정하고 공지했어요.'}],
...
(function(){
  ...
  var STEPS_KO=[
   ...
   {cap:'역할을 나눠요', sub:'책임 카드 → 선호·회피 폼 → 균형 배정', member:'form', who:'이민지', channel:'카카오톡', think:'책임 카드 분해 중', send:'선호도 폼 전송',
    ...
    form:{type:'poll', title:'맡고 싶은 카드 고르기', opts:['폼 UX','대시보드','데모 스토리'], sel:'폼 UX'},
...
var STEPS_EN=[
 ...
 {cap:"Split the roles",sub:"Responsibility cards → preference form → balanced assignment",member:"form",who:"Minji",channel:"KakaoTalk",think:"Roles",send:"Sending",cmd:"Start <b>role assignment</b> based on the roadmap",draft:"<b>6 responsibility cards</b> from the roadmap.<br>Planning · Backend API · Form UX · Dashboard · QA · Demo story<br><span>Send the preference survey?</span>",kko:"<b>[TeamplayTalk]</b> Role preference survey<br><span>Respond &#9656;</span>",form:{type:"poll",title:"Choose cards you want",opts:["Form UX","Dashboard","Demo story"],sel:"Form UX"},result:"Sewon <b>Planning · QA</b> · Bonggu <b>Backend API</b><br>Minji <b>Form UX · Demo story</b> · Juho <b>Dashboard</b> <span>Confirm?</span>"},
