...
.wave-underline{position:absolute;left:-3%;bottom:-14px;width:106%;height:14px;overflow:visible;z-index:2;filter:drop-shadow(0 5px 10px rgba(124,58,237,.14))}
.wave-underline path{stroke-dasharray:120;stroke-dashoffset:120;animation:mlgLineIn .86s cubic-bezier(.22,1,.36,1) .45s forwards}
@keyframes mlgLineIn{to{stroke-dashoffset:0}}
...
@media (prefers-reduced-motion: reduce){
  *,*:before,*:after{animation:none!important;transition:none!important}
  ...
  .wave-underline path{stroke-dashoffset:0}
}
"""
