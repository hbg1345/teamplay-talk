...
def register(mcp: FastMCP) -> None:
    ...
    async def assign_roles(
        ...
        ② 작업 분해 — 산출물 만드는 데 필요한 작업을 **최대한 잘게** 나열
        ③ 역할화 — **비슷한 작업끼리 묶어** 응집성 있는 역할로. **역할 수가 팀원 수보다 많아도 됨**
           (난이도 균형으로 한 명이 여러 역할 받음). 단 순위 매기기 좋게 과하게 잘진 말기(보통 팀원수~2배).
        ④ 난이도 — 역할별 업무량·난이도 1~10 (범위 넓고 어려울수록 높게)
        예: 로봇캡스톤 4명 → [{"name":"기구설계","difficulty":8},{"name":"회로/전자","difficulty":7},
        {"name":"제어/SW","difficulty":8},{"name":"펌웨어/통신","difficulty":6},{"name":"문서/발표","difficulty":3}]
        (역할 5개 > 팀원 4명 — finalize_roles가 균형 배분)
