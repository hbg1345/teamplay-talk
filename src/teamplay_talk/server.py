...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "책임 카드 수는 현재 방 팀원 수의 1~2배로 만들고, 가능하면 1.5배 근처로 맞춰라. 팀원 4명이면 4~8개, 추천 6개다. "
        "단, 현재 방에 방장 1명만 있으면 팀원 수 기준으로 2개 카드로 강제 병합하지 마라. 이때는 4~6개 정도의 책임 카드 초안만 보여주고, 팀원 초대 후 선호/회피 조사를 보내라고 안내하라. "
